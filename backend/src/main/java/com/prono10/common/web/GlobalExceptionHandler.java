...
public class GlobalExceptionHandler {
     ...
     */
    @ExceptionHandler(com.prono10.auth.email.MailDeliveryException.class)
    public ProblemDetail handleMailFailure(com.prono10.auth.email.MailDeliveryException ex) {
