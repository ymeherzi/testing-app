...
class PlayerPredictionsIT {
    ...
    void rivalPicksAreHiddenBeforeKickoffAndRevealedAfter() throws Exception {
        ...
        tx.executeWithoutResult(s -> {
            ...
            s.flush();
            predictions().save(new com.tengames.prediction.Prediction(
    ...
    @Autowired
    private com.tengames.prediction.PredictionRepository predictionRepository;

    private com.tengames.prediction.PredictionRepository predictions() {
