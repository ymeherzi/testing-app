...
import com.prono10.prediction.PredictionService;
...
class PlayerPredictionsIT {
    ...
    void rivalPicksAreHiddenBeforeKickoffAndRevealedAfter() throws Exception {
        ...
        tx.executeWithoutResult(s -> {
            ...
            s.flush();
            predictions().save(new com.prono10.prediction.Prediction(
    ...
    @Autowired
    private com.prono10.prediction.PredictionRepository predictionRepository;

    private com.prono10.prediction.PredictionRepository predictions() {
