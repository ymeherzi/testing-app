...
class SeedSyncIT {
    ...
    void persistsScoresAndStatusesFromTheProvider() {
        ...
        assertThat(finished.getStatus()).isEqualTo(com.predictor.catalog.MatchStatus.FINISHED);
        ...
        assertThat(inPlay.getStatus()).isEqualTo(com.predictor.catalog.MatchStatus.IN_PLAY);
